...
## Persistence options
Because Streamlit Cloud's filesystem is ephemeral, saved articles can disappear if the container is restarted. To make storage durable you can enable git-backed persistence:
